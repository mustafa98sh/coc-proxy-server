...
exports.getClashData = onRequest(async (req, res) => {
    ...
    try {
        // 1. فحص وسحب الـ IP الذي تخرج منه الدالة حالياً
        const ipResponse = await axios.get("https://api.ipify.org?format=json");
        console.log("MY_FIREBASE_IP: ", ipResponse.data.ip); // <--- سيطبع الـ IP هنا
